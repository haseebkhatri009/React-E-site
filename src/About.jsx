    ...
    <>
            ...
            <div className="container mx-auto px-4 mt-10 max-w-[1200px]">
                <div className="flex justify-center">
                    <h1 className="text-4xl  text-gray-800 font-semibold">About Us</h1>
                </div>

                <div className="text-center mt-8">
                    <p className="text-lg text-gray-600 leading-relaxed">
                        Welcome to <strong>Exclusive Store</strong> – the ultimate destination for all your shopping needs. We bring you high-quality products from the best brands, all in one place. Whether you are looking for fashion, electronics, home decor, or beauty essentials, we have got you covered.
                    </p>
                ...
                <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-400">
                        <div className=" flex justify-center"><img src="https://img.drz.lazcdn.com/static/pk/p/4d1a4de6ef21b2ae13dd0b827e6fa531.png_720x720q80.png_.webp" alt="Fashion" className="w-full h-56 object-cover" /></div>
                        <div className="p-6">
                    ...
                    {/* Card 2 */}
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-400">
                        <div className=" flex justify-center"><img src="https://img.buzzfeed.com/buzzfeed-static/static/2020-08/20/6/asset/274e17366b88/sub-buzz-4149-1597906428-10.jpg?downsize=700%3A%2A&output-quality=auto&output-format=auto" alt="Electronics" className=" h-[220px] mt-2 w-[60%] object-cover" /></div>
                        <div className="p-6">
                    ...
                    {/* Card 3 */}
                    <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-400" >
                        <div className=" flex justify-center"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdSLrsGO_zdDXHEN4P4kvD27wLLiROBq4_lQ&s" alt="Home Decor" className="w-[100%]  h-[224px] object-fit" /></div>
                        <div className="p-6">
